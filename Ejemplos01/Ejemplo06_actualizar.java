...
public class Ejemplo06_actualizar {
    public static void main(String[] args){
        ...
        try{
            ...
            String SQL ="UPDATE producto SET nombre='GHH-3', proveedor='ZPB-co' WHERE id=255";
            st.execute(SQL);
            System.out.println("Registro actualizado en la tabla.");
            st.close();
            cn.close();
...
/*
    ...
    5 - Cerrar statement, resultset y conexión
*/